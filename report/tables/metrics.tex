...
\begin{tabular}{@{}llll@{}}
\toprule
\textbf{Page} & \textbf{RDFa type} & \textbf{MF2 classes} & \textbf{Properties} \\
\midrule
...
Champions list    & schema:ItemList        & —              & itemListElement (Person) \\
Home page         & schema:Dataset         & —              & name, description, license, temporalCoverage \\
\bottomrule
\end{tabular}
\end{center}
